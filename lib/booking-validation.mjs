...
const nightKey=iso=>{const p=istParts(iso),minutes=p.hour*60+(p.minute||0);if(!(minutes>22*60||minutes<=5*60))return null;let stamp=Date.UTC(p.year,p.month-1,p.day);if(minutes<=5*60)stamp-=86400000;return new Date(stamp).toISOString().slice(0,10)};
